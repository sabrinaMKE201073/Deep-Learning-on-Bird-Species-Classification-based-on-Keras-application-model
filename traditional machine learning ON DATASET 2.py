# -*- coding: utf-8 -*-
"""
TRADITIONAL MACHINE LEARNING (image classification) ON [DATASET 2]
"""
...
train_images = []
train_labels = [] 
for directory_path in glob.glob("dataset 2/test_data/test_data/*"):
...
test_images = []
test_labels = [] 
for directory_path in glob.glob("dataset 2/train_data/train_data/*"):
