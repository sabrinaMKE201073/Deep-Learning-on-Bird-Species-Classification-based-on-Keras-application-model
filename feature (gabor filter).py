...
sigma = 4 #Large sigma on small features will fully miss the features. 
...
img = cv2.imread('dataset 2 (kaggle world chosen bird species)/train/BARN SWALLOW/001.jpg')
#img = cv2.imread('C:/Users/nurul/Python/bird data training set (95 pic each)/Asian Openbill/Image_79.jpg')  #Image source wikipedia: https://en.wikipedia.org/wiki/Plains_zebra
#img = cv2.imread('C:/Users/nurul/Python/bird data training set (95 pic each)/Asian Openbill/Image_79.jpg') #USe ksize:15, s:5, q:pi/2, l:pi/4, g:0.9, phi:0.8

plt.imshow(img, cmap='gray')
#plt.subplot(img, cmap='gray')
