...
TRADITIONAL MACHINE LEARNING (image classification) ON MA
...
print(os.listdir("dataset 1 (malaysia bird)")) 
...
train_images = []
train_labels = [] 
for directory_path in glob.glob("dataset 1 (malaysia bird)/bird data training set (95 pic each)/*"):
...
test_images = []
test_labels = [] 
for directory_path in glob.glob("dataset 1 (malaysia bird)/bird data validation set/*"):
